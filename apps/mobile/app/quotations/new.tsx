...
import { useCreateQuotation, useListBranches, useListCustomers, useListProjects } from "@rmixerp/contract";
      ...
      { data: { customerId, branchId, ...(projectId && { projectId }), ...(notes && { notes }) } },
      {
        onSuccess: (result) => {
          if (result.status === 201) {
            ...
            setError("Could not create the quotation.");
          }
        },
        onError: () => setError("Could not create the quotation."),
      },
    );
  }
